...
char server[50] = "a2geapajmwonm2-ats.iot.us-east-1.amazonaws.com";

//char wifi_ssid[]       = "DK";
//char wifi_password[]   = "12345678";
char aws_endpoint[]    = "a2geapajmwonm2-ats.iot.us-east-1.amazonaws.com";
char aws_key[]         = "AKIA45IPCKAKP3TSIKEL";
char aws_secret[]      = "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";
char aws_region[]      = "us-east-1";
const char* aws_topic  = "$aws/things/KishoreThingNV/shadow/update";
int port = 443;
